...
import {postComment, fetchCampsites, fetchComments, fetchPromotions} from '../redux/ActionCreators'; //Dispatching Reducers
  ...
  render() {
      const HomePage = () => {
          return(
              ...
              promotionLoadind ={this.props.promotions.isLoading}
